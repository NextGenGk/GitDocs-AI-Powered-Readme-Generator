...
export default function FeaturesSection() {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 relative z-10 py-6 sm:py-8 md:py-10 px-4 sm:px-6 md:px-8 max-w-7xl mx-auto">
...
const Feature = ({
    ...
    return (
        ...
        >
            {index < 4 && (
                <div className="opacity-0 group-hover/feature:opacity-100 transition duration-200 absolute inset-0 h-full w-full bg-[linear-gradient(to_right,#f2fcfe,#7367f0)] pointer-events-none" />
            )}
            {index >= 4 && (
                <div className="opacity-0 group-hover/feature:opacity-100 transition duration-200 absolute inset-0 h-full w-full bg-[linear-gradient(to_right,#f2fcfe,#7367f0)] pointer-events-none" />
            )}
